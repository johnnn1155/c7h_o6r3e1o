...
const port = process.env.SERVER_PORT || process.env.PORT || 1280;        
const UUID = process.env.UUID || '38d51dcf-3194-42fd-a1d8-cabec9806c1e'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'NWRkVlM5M0hlOfgDgw';
